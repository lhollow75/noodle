    ...
    a.extend(a.fn, {
        validate: function(b) {
            if (this.length) {
                ...
                return c ? c : (c = new a.validator(b, this[0]), a.data(this[0], "validator", c), c.settings.onsubmit && (this.find("input, button").filter(".cancel").click(function() {
                    c.cancelSubmit=!0
        ...
        prototype: {
            init: function() {
                function b(b) {
                    ...
                    b = "on" + b.type.replace(/^validate/, ""), c.settings[b] && c.settings[b].call(c, this[0])
                }
                ...
                }), a(this.currentForm).validateDelegate(":text, :password, :file, select, textarea", "focusin focusout keyup", b).validateDelegate(":radio, :checkbox, select, option", "click", b), this.settings.invalidHandler && a(this.currentForm).bind("invalid-form.validate", this.settings.invalidHandler)
            },
            form: function() {
            ...
            element: function(b) {
                this.lastElement = b = this.clean(b), this.prepareElement(b), this.currentElements = a(b);
                var c = this.check(b);
            ...
            resetForm: function() {
                a.fn.resetForm && a(this.currentForm).resetForm(), this.submitted = {}, this.prepareForm(), this.hideErrors(), this.elements().removeClass(this.settings.errorClass)
            },
                ...
                for (e in c) {
                    ...
                    try {
                        ...
                        if ("dependency-mismatch" == g)
                            ...
                            if (!g)
                                return this.formatAndAdd(b, f), !1
                        }
                    } catch (a) {
                        throw this.settings.debug && window.console && console.log("exception occured when checking element " + b.id + ", check the '" + f.method + "' method", a), a
                    }
                }
                if (!d)
        ...
        methods: {
                ...
                return g[c.name] = b, a.ajax(a.extend(!0, {
                    ...
                    success: function(d) {
                        ...
                        if (g) {
                            ...
                            h = {}, d = d || f.defaultMessage(c, "remote"), h[c.name] = e.message = a.isFunction(d) ? d(b) : d, f.showErrors(h);
            ...
            creditcard: function(a, b) {
                ...
                for (var f = a.length - 1; f >= 0; f--)
                    d = a.charAt(f), d = parseInt(d, 10), e && (d*=2) > 9 && (d -= 9), c += d, e=!e;
                return c%10 == 0
            },
