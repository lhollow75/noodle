...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=6c9bf22f81c9a8ce9adca3e81fd7c11a)
 * Config saved to config.json and https://gist.github.com/6c9bf22f81c9a8ce9adca3e81fd7c11a
 */
...
+ function(t) {
    ...
    a.VERSION = "3.3.6", a.prototype.toggle = function(s) {
        ...
        if (!n.is(".disabled, :disabled")) {
            ...
            if (i(), !a) {
                ...
                if (o.trigger(s = t.Event("show.bs.dropdown", r)), s.isDefaultPrevented())
                    return;
    ...
    i.VERSION = "3.3.6", i.TRANSITION_DURATION = 150, i.prototype.show = function() {
        ...
        if (s || (s = e.attr("href"), s = s && s.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
            var n = i.find(".active:last a"), o = t.Event("hide.bs.tab", {
                relatedTarget: e[0]
    ...
    i.VERSION = "3.3.6", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if ("bottom" == this.affixed)
            return null != i ? n + this.unpin <= o.top?!1 : "bottom" : t - s >= n + a?!1 : "bottom";
        ...
        if (this.$element.is(":visible")) {
            var e = this.$element.height(), s = this.options.offset, n = s.top, o = s.bottom, a = Math.max(t(document).height(), t(document.body).height());
